    ...
    <div className="">
      <div className="navbar bg-base-100 shadow-sm px-6">
        <div className="navbar-start">
          ...
          <a className="flex items-center gap-2 text-gradient cursor-pointer">
        ...
        <div className="navbar-end">
          <button className="flex items-center gap-2 rounded-md bg-gradient-to-r from-[#632EE3] to-[#9F62F2] text-white font-semibold px-6 py-3 cursor-pointer">
            <FaGithub />
            Contribute
          </button>
        </div>
